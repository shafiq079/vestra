...
- **Backend development is authorised and is the active work.** `backend/` is the primary
  write scope.
- **Phase 0A, 0B and Phase 1 are complete and merged.** Phase 1 delivered the Express /
  TypeScript foundation, MongoDB connection handling, `GET /api/health`, the error contract,
  and the test harness.
- **Phase 2 (database/schema design) is next.** It has not been started.
